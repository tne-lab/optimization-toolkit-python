        ...
        if (event.key === "1" || event.key === "2" || event.key === "3") {
            ...
            try {
                var data = {
                    ...
                    trial: reactionTimes.length+1,
                    Trialtype: randomNumberElement1.textContent + randomNumberElement2.textContent + randomNumberElement3.textContent,
                    NumberResponded: NumberResponded,
                    RT : responseTime.toFixed(5),
                    Response: accuray
                };
            window.electronAPI.setTitle(JSON.stringify(data));
            } catch (error) {
