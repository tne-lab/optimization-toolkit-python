...
def ts_armselect_blockwise_prior_update(bookV, vL, disV, exp_distribution_type):
    ...
    # Arm count - removing arm count function
    bookV['playArmSelected'][bookV['trial']+1] = bookV['armselected']
    ...
    # print("NEXT: trial #: ", bookV['trial']+1, "STIMULATION RECOMMENDATION:", bookV['armselected'])
    return bookV
